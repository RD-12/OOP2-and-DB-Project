  ...
  public static void main(String[] args) 
  {
		EventQueue.invokeLater(new Runnable() 
		{
			public void run() 
			{
				try
				{
					medical_Errors window = new medical_Errors();
	...
	private void initialize() 
	{
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"names of the lawyers", "Sami Abdullah        700 SR", "Tamim Mohsen       1000 SR", " Razan Khaled          500 SR", "Malak Fahd              1200 SR", "Rashid Saleh             900 SR", "Hadeel Hassan          400 SR"}));
		comboBox.setBounds(104, 237, 526, 96);
		frame.getContentPane().add(comboBox);

		
		JLabel Label = new JLabel("  ");
		Label.setLocation(6, -12);
		Label.setIcon(new ImageIcon("/Users/rawan/Desktop/11.png"));
		Label.setSize(788,825);

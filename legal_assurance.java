...
public class legal_assurance {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					legal_assurance window = new legal_assurance();
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"names of the lawyers", "Thamer Abdel Aziz         600 SR", "Mazen Khalaf                500 SR", "Ramy Saeed                 400 SR", "Faisal Hashem            300 SR", "Yazan Abdel Rahman    400 SR", "Ammar Muhammad       400 SR"}));
		comboBox.setBounds(104, 237, 526, 96);
		frame.getContentPane().add(comboBox);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("/Users/rawan/Desktop/14.png"));

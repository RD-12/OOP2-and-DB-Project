...
public class Tax_case {
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"names of the lawyers", "Mashari  dhafer            600 SR", " Jude Ali                        1200 SR", "Fatima Essa                  400 SR", "Nora Majid                    900 SR", "Reem  Ali                      400 SR", "Maha Abdulaziz            500 SR"}));
		comboBox.setBounds(104, 237, 526, 96);
		frame.getContentPane().add(comboBox);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("/Users/rawan/Desktop/١٦.png"));
		lblNewLabel.setBounds(6, 0, 788, 796);

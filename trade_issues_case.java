...
public class trade_issues_case {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					trade_issues_case window = new trade_issues_case();
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"names of the lawyers", "Muhammad Abdulaziz    600 SR", "Mona Thunayan               500 SR", "Iman Younes                  400 SR", "Amira Youssef               300 SR", "Maryam Saad                400 SR", "Sarah Omar                   400 SR"}));
		comboBox.setBounds(104, 237, 526, 96);
		frame.getContentPane().add(comboBox);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("/Users/rawan/Desktop/١٥.png"));

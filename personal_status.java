...
public class personal_status {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					personal_status window = new personal_status();
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"names of the lawyers", "Ali Abdullah               600 SR", "Salman Abdul Rahman   500 SR", "Khaled Ali                    400 SR", "Mashael Ahmed        300 SR", "Maria Mazen              400 SR", "Lujain Abdullah           400 SR"}));
		comboBox.setBounds(104, 237, 526, 96);
		frame.getContentPane().add(comboBox);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("/Users/rawan/Desktop/13.png"));
